...
ActiveRecord::Schema.define(version: 20220714003826) do
  ...
  create_table "fae_deploy_hooks", force: :cascade do |t|
    ...
    t.datetime "updated_at",  null: false
    t.integer  "position"
    t.index ["environment"], name: "index_fae_deploy_hooks_on_environment", using: :btree
    t.index ["position"], name: "index_fae_deploy_hooks_on_position", using: :btree
  end
  ...
  create_table "fae_form_managers", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["form_manager_model_id"], name: "index_fae_form_managers_on_form_manager_model_id", using: :btree
    t.index ["form_manager_model_name"], name: "index_fae_form_managers_on_form_manager_model_name", using: :btree
  end
